...
export function Honda({color}: SVGComponentProps) {
  return (
    <svg fill={color} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44.6 44.6" width="100px" height="100px">
      <g>
