...
export function Tesla({color}: SVGComponentProps) {
  return (
    <svg fill={color} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 320" width="100px" height="100px">
      <g id="tesla">
        <g id="T">
